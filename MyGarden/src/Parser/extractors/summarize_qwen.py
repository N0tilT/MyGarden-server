...
async def main():
    with open("../catalogues/stroy_podskazka/data/translated_flowers.json", "r", encoding="utf-8") as f, \
         open('../catalogues/stroy_podskazka/data/sum_flowers.json', 'w', encoding='utf-8') as out_file:
